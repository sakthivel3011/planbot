...
const WhatsAppSending = ({ isOpen, onClose, selectedMembers = [], eventName = '', companyName = '' }) => {
  ...
  const [feedbackLink, setFeedbackLink] = useState('cmckec.vercel.app/feedback');
...
We're excited to have you as part of this amazing event!
Stay updated with our events, competitions & cultural activities.
Website: cmckec.vercel.app

For any queries, contact: 89254 90989

This is an automated account. Replies are not monitored.

Welcome to the {eventName}! 🎵`
    },
    'event-reminder': {
      name: '⏰ Event Reminder',
      template: `🎶 Cultural & Music Club - KEC 🎶
...
Don't miss out on this amazing cultural experience!
Website: cmckec.vercel.app
...
Get ready for an amazing journey of music, culture & creativity!
Website: cmckec.vercel.app
...
Thank you for being part of our cultural journey! 🎵`
    },
    'custom': {
